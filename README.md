...
1. **Clone the repository**: 
   `git clone https://github.com/Tocinito3/personal-website.git`
2. **Navigate to the project directory**.
3. **Open the project**: Open `index.html` in your browser or use the **VS Code Live Server** extension to view the site on `127.0.0.1:3000`.

## 🎓 Credentials
* **Course**: CST-120 - Web Development.
