// ==========================================================================
// 1. GLOBAL IMAGE FALLBACK (Runs on all pages)
// ==========================================================================
document.querySelectorAll('img').forEach(img => {
    // The SVG image we want to show if things break
    const fallbackSrc = 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="400"><rect width="100%" height="100%" fill="%23ecf0f1"/><text x="50%" y="50%" fill="%237f8c8d" font-size="24" font-family="sans-serif" text-anchor="middle" dominant-baseline="middle">📸 Image Not Found</text></svg>';

    // A reusable function to apply the placeholder
    const applyPlaceholder = () => {
        img.onerror = null; // Prevent infinite loops
        img.src = fallbackSrc;
    };

    // Scenario A: The image breaks AFTER this script loads
    img.addEventListener('error', applyPlaceholder);

    // Scenario B: The image ALREADY broke BEFORE this script loaded
    // (If the image says it's "complete" but has a width of 0, we know it failed)
...
// ==========================================================================
// 2. INTERACTIVE MAP LOGIC (Only runs on map.html)
// ==========================================================================
